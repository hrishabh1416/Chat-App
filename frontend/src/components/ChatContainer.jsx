...
//       {/* Fixed Header */}
//       <div className="h-[60px] px-4 py-3 flex items-center border-b border-stone-500 bg-black/40 backdrop-blur-md sticky top-0 z-20">
//         <img
//           src={selecteduser.profilePic || assets.avatar_icon}
//           className="w-8 rounded-full"
//           alt="profile"
//         />
//         <p className="flex-1 text-lg text-white flex items-center gap-2 ml-3">
...
//           className="max-md:hidden w-5 ml-3 cursor-pointer"
//           alt="open profile"
//         />
//       </div>
  ...
  return (
    <div className="relative h-full w-full flex flex-col bg-gradient-to-br from-[#071d33] to-[#1a0033]">
      ...
      <div className="h-[60px] px-4 py-3 flex items-center justify-between border-b border-stone-500 bg-black/40 backdrop-blur-md sticky top-0 z-20">
        ...
        {/* Right Section: Info icon (visible on all screens now) */}
        <img
          onClick={onProfileClick}
          src={assets.help_icon}
