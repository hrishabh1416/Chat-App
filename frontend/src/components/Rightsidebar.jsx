...
//   },[messages])
//   return selecteduser && (
//     <div className="flex flex-col justify-between h-full px-5 pt-16 text-xs font-light relative">
//       {/* Top Section */}
...
//         <button onClick={()=>logout()}  className='bg-gradient-to-r from-purple-400 to-violet-600 text-white text-sm font-light py-2 px-20 rounded-full cursor-pointer'>
//           Logout
//         </button>
//       </div>
//     </div>
